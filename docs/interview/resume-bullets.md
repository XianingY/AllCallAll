...
- Added a Python-side Agent Runtime eval runner covering task success, citation grounding, tool intent match, approval safety, prompt schema presence, grounding-check trace, and unsupported-claim guarding across 8 deterministic LangGraph task fixtures.
