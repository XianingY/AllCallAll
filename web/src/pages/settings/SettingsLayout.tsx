import { Ban, Bell, CreditCard, FileText, Globe2, KeyRound, MonitorSmartphone, ShieldAlert, UserRound } from "lucide-react";
...
const links = [
  ...
  ["/settings/notifications", "通知", Bell], ["/settings/billing", "订阅", CreditCard],
  ["/settings/preferences", "偏好", Globe2], ["/settings/legal", "法律信息", FileText],
  ["/settings/danger", "账号删除", ShieldAlert],
] as const;
