...
用于将 Helsinki-NLP/opus-mt-zh-en 模型转换为 INT8 量化的 ONNX 格式
"""
...
def convert_and_quantize_model():
    ...
    model_path = 'assets/models/opus/zh-en'
    onnx_path = Path('assets/models/opus/zh-en/opus-mt-zh-en.onnx')
    quantized_path = Path('assets/models/opus/zh-en/opus-mt-zh-en-q8.onnx')
...
if __name__ == "__main__":
    ...
    # 创建输出目录
    os.makedirs('assets/models/opus/zh-en', exist_ok=True)
